      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                  ...
                  <div class="space-y-4">
                      <a 
                          href="buymeacoffee.com/Asthriona" 
                          target="_blank" 
                          rel="noopener noreferrer"
                      ...
                      >
                          <img 
                              class="h-8" 
                              src="https://cdn.asthriona.com/i/2024/10/%25pn_241022-191853.png" 
                              alt="Buy Me a Coffee"
                          />
                      </a>
                      <iframe 
                          src="https://github.com/sponsors/Asthriona/button" 
                          title="Sponsor Asthriona" 
                          height="32" 
                          width="114" 
          ...
          <div class="border-t border-gray-800 pt-8">
              <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                  ...
                  <!-- Version Badge -->
                  <div 
                      class="px-4 py-1 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 
